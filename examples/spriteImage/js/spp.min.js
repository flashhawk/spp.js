var SPP=SPP||{REVISION:"alpha",AUTHOR:"flashhawk",BLOG:"flashquake.cn"};SPP.inherit=function(a){function b(){}if(null==a)throw TypeError();if(Object.create)return Object.create(a);var c=typeof a;if("object"!==c&&"function"!==c)throw TypeError();b.prototype=a;return new b};SPP.extend=function(){};SPP.frameTime=0;
...
SPP.Vector2D.prototype={constructor:SPP.Vector2D,toString:function(){return"[Vector2D (x="+this.x+" y="+this.y+")]"},clone:function(){return new SPP.Vector2D(this.x,this.y)},reset:function(a,b){this.x=a||0;this.y=b||0},equals:function(a){return this.x==a.x&&this.y==a.y},plus:function(a){this.x+=a.x;this.y+=a.y},plusNew:function(a){return new SPP.Vector2D(this.x+a.x,this.y+a.y)},minus:function(a){this.x-=a.x;this.y-=a.x},minusNew:function(a){return new SPP.Vector2D(this.x-a.x,this.y-a.y)},negate:function(){this.x*=
...
this.height+")]"}};SPP.Particle=function(){SPP.EventDispatcher.call(this);this.position=new SPP.Vector2D;this.velocity=new SPP.Vector2D;this.damp=new SPP.Vector2D(0.1,0.1);this.life=Infinity;this.forcesMap={};this.extra={};this.resultant=new SPP.Vector2D;this.boundary=null;this.boundaryType=SPP.Particle.OFFSCREEN;this.bounceIntensity=2;this.onUpdate=null};SPP.Particle.OFFSCREEN="offscreen";SPP.Particle.BOUNCE="bounce";
SPP.Particle.prototype={constructor:SPP.Particle,init:function(a,b,c){0>=c?this.dispatchEvent(new SPP.Event("dead")):(this.life=c||Infinity,this.position.reset(a,b))},addForce:function(a,b){this.forcesMap[a]=b},removeForce:function(a){delete this.forcesMap[a]},removeAllForces:function(){for(var a in this.forcesMap)delete _forces[a]},render:function(){this.update();this.onUpdate&&this.onUpdate.apply(this);this.resultant.reset(0,0);for(var a in this.forcesMap)this.forcesMap[a].isActive()?this.resultant.plus(this.forcesMap[a].value):
(delete this.forcesMap[a],this.forcesMap[a]=null);this.velocity.plus(this.resultant);this.velocity.x*=1-this.damp.x;this.velocity.y*=1-this.damp.y;this.position.plus(this.velocity);if(null!=this.boundary)this[boundaryType]();this.life-=SPP.frameTime;0<this.life||this.dispatchEvent(new SPP.Event("dead"))},update:function(){},bounce:function(){if(this.position.x<this.boundary.left()||this.position.x>this.boundary.right())this.position.x=this.position.x<this.boundary.left()?this.boundary.left():this.boundary.right(),
this.velocity.scaleX(-this.bounceIntensity);if(this.position.y<this.boundary.top()||this.position.y>this.boundary.bottom())this.position.y=this.position.y<this.boundary.top()?this.boundary.top():this.boundary.bottom(),this.velocity.scaleY(-this.bounceIntensity);this.resultant.scale(0)},offscreen:function(){this.position.x<this.boundary.left()&&(this.position.x=this.boundary.right());this.position.x>this.boundary.right()&&(this.position.x=this.boundary.left());this.position.y<this.boundary.top()&&
(this.position.y=this.boundary.bottom());this.position.y>this.boundary.bottom()&&(this.position.y=this.boundary.top())},destory:function(){},reset:function(){this.position.reset(0,0);this.velocity.reset(0,0);this.damp.reset(0.1,0.1);this.life=0;this.forcesMap={};this.extra={};this.resultant.reset(0,0);this.boundary=null;this.boundaryType=SPP.Particle.OFFSCREEN;this.bounceIntensity=2;this.onUpdate=null},toString:function(){return"particle:\n[\n\tlife:"+this.life+",\n\tposition:"+this.position.toString()+
",\n\tvelocity:"+this.velocity.toString()+",\n\tresultant:"+this.resultant.toString()+",\n\tboundaryType:"+this.boundaryType.toString()+",\n\tboundary:"+(null!=this.boundary?this.resultant.toString():"null")+",\n\tbounceIntensity:"+this.bounceIntensity+",\n\tdamp:"+this.damp.toString()+",\n\textra:"+this.extra.toString()+",\n\tonUpdate:"+(null!=this.onUpdate?this.onUpdate.toString():"null")+"\n]\n"}};SPP.ParticlePool=function(){var a=[];this.get=function(b){for(var c in a)if(a[c].constructor===b)return a.splice(c,1)[0];return new b};this.recycle=function(b){a.push(b)};this.getParticles=function(){return a}};SPP.ParticleSystem=function(){var a=[],b=new SPP.ParticlePool,c=null,d=this;this.getParticles=function(){return a};this.createParticle=function(c){c=b.get(c);c.reset();c.addEventListener("dead",e);a.unshift(c);return c};var e=function(a){d.removeParticle(a.target)};this.removeParticle=function(c){var d=a.indexOf(c);-1!=d&&(a.splice(d,1),c.removeEventListener("dead",e),b.recycle(c))};this.removeAllParticles=function(){for(var b=a.length;0<b--;)this.removeParticle(a[b]);a=[]};this.render=function(){null==
c&&(c=Date.now());SPP.frameTime=0.001*(Date.now()-c);c=Date.now();for(var b=a.length;0<b--;)a[b].render()};this.resume=function(){c+=Date.now()-c};this.getParticlePool=function(){return b}};SPP.Force=function(a,b,c){SPP.EventDispatcher.call(this);this.value=new SPP.Vector2D(a,b);this.life=c||Infinity};SPP.Force.prototype={constructor:SPP.Force,isActive:function(){if(0>=(this.life-=SPP.frameTime))return this.destory(),dispatchEvent(new SPP.Event("dead")),!1;this.update();return!0},update:function(){},destory:function(){}};SPP.Brownian=function(a,b,c){SPP.Force.call(this,0,0,c);this.maxValue=a;this.cycle=b;this.pastTime=0;this.value.reset((2*Math.random()-1)*this.maxValue,(2*Math.random()-1)*this.maxValue)};SPP.Brownian.prototype=SPP.inherit(SPP.Force.prototype);SPP.Brownian.prototype.constructor=SPP.Brownian;SPP.Brownian.prototype.update=function(){this.pastTime+=SPP.frameTime;this.pastTime>=this.cycle&&(this.value.reset((2*Math.random()-1)*this.maxValue,(2*Math.random()-1)*this.maxValue),this.pastTime=0)};
SPP.Brownian.prototype.destory=function(){};SPP.Gravity=function(a){SPP.Force.call(this,0,a,Infinity)};SPP.Gravity.prototype=SPP.inherit(SPP.Force.prototype);SPP.Gravity.prototype.constructor=SPP.Gravity;SPP.Attraction=function(a,b,c,d){SPP.Force.call(this,0,0,d);this.maxValue=b;this.r=c;this.attractionPosition=a;this.targetParticle=null;this.attractionPoint=new SPP.Point;this.targetPoint=new SPP.Point};SPP.Attraction.prototype=SPP.inherit(SPP.Force.prototype);SPP.Attraction.prototype.constructor=SPP.Attraction;
SPP.Attraction.prototype.update=function(){this.attractionPoint.copyFromVector(this.attractionPosition);this.targetPoint.copyFromVector(this.targetParticle.position);var a=SPP.Point.distance(this.attractionPoint,this.targetPoint);this.value=a<this.r?this.targetParticle.position.minusNew(this.attractionPosition):this.attractionPosition.minusNew(this.targetParticle.position);this.value.scale(this.maxValue/a)};SPP.MathUtils=function(){};SPP.MathUtils.toDegree=function(a){return 180*(a/Math.PI)};SPP.MathUtils.toRadian=function(a){return a/180*Math.PI};SPP.MathUtils.sinD=function(a){return Math.sin(SPP.MathUtils.toRadian(a))};SPP.MathUtils.asinD=function(a){return SPP.MathUtils.toDegree(Math.asin(a))};SPP.MathUtils.cosD=function(a){return Math.cos(SPP.MathUtils.toRadian(a))};SPP.MathUtils.acosD=function(a){return SPP.MathUtils.toDegree(Math.acos(a))};SPP.MathUtils.tanD=function(a){return Math.tan(SPP.MathUtils.toRadian(a))};
SPP.MathUtils.atanD=function(a){return SPP.MathUtils.toDegree(Math.atan(a))};SPP.MathUtils.atan2D=function(a,b){return SPP.MathUtils.toDegree(Math.atan2(a,b))};SPP.MathUtils.random=function(a){return a*Math.random()>>0};SPP.UIDUtil={_counter:0};SPP.UIDUtil.createUID=function(a){var b=a.charCodeAt(a.length-1);48<=b&&57>=b&&(a+="_");return a+this._counter++};SPP.SpriteImage=function(){SPP.Particle.call(this);this.texture=this.context=null;this.scale=1;this.rotation=0;this.alpha=1;this.regY=this.regX=0.5};SPP.SpriteImage.prototype=SPP.inherit(SPP.Particle.prototype);SPP.SpriteImage.prototype.constructor=SPP.SpriteImage;
